...
continuously. When the scan did not complete successfully
we stop the scanning process of that worker.
'''
...
'''
Main function were we create a number of workers
equivalent to the number of CPU cores.
