#!/usr/bin/env python3
'''
This module facalitates the creating of an environment necessary for the app to function.
...
the installed packages that are found in the OS's database including the vulnerability status.
'''
def insert_packages():
